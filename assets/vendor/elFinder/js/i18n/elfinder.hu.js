...
(function(root, factory) {
	...
	elFinder.prototype.i18.hu = {
		...
		messages   : {
			...
			'cmdempty'     : 'Mappa ürítése', // from v2.1.25 added 22.06.2017
			...
			'cmdselectall' : 'Összes kijelölése', // from v2.1.28 added 15.08.2017
			'cmdselectnone': 'Nincs kijelölt', // from v2.1.28 added 15.08.2017
			'cmdselectinvert': 'Kiválasztás invertálása', // from v2.1.28 added 15.08.2017
			'cmdopennew'   : 'Open in new window', // from v2.1.38 added 3.4.2018
			'cmdhide'      : 'Elrejtés (Preference)', // from v2.1.41 added 24.7.2018
			...
			'dropPasteFiles'  : 'Húzz ide egy fájlt', // from v2.1 added 07.04.2014
			...
			'selectFolder'    : 'Válassz ki egy mappát', // from v2.1.20 added 13.12.2016
